...
public class GameRunner extends JPanel implements KeyListener {
    ...
    */
    ...
    public void paint(Graphics g)
    {
        try
        {
            //NOTE: CODE BELOW PLAYS ANIMATIONS FOR LEVEL INTROS
            //DIFFERENT LEVELS HAVE DIFFERENT INTROS, REQUIRING DIFFERENT CODE FOR EACH
    ...
    public void start(String name, int slot)
    {
        ...
        gameFrame.setIconImage(ImageManager.getImage(86));
